...
namespace DAL.Repository
{
    class IngredientRepository : IIngredientRepository
    {
        ...
        {
            var stmt = @"delete from ingredients where id_ingredients = @id";
        ...
        public async Task<Ingredients> GetAsync(int id)
        {
            ...
            var stmt = @"select * from ingredients where id_ingredients = @id";
        ...
        {
            var stmt = @"UPDATE  ingredients SET Name = @Name, Price= @PriceWHERE id_ingredients = @id";
