...
namespace BO.Entity
{
    ...
    public class Ingredients
    {
        ...
        public Ingredients(int? id_ingredients, string name, decimal price)
        {
        ...
        public override bool Equals(object obj)
        {
            return obj is Ingredients ingredients &&
                   Id_ingredients == ingredients.Id_ingredients &&
        ...
        {
            return HashCode.Combine(Id_ingredients, Name, Price);
        }
    }
}
